...
cp "$PAGE" ".backup_tarot/index.js.$(date +%Y%m%d_%H%M%S)" || true

# Réécriture du fichier avec gestion des index pour afficher les images
cat > "$PAGE" <<'JS'
...
echo "✅ Fichier $PAGE mis à jour (backup dans .backup_tarot/)"
